...
program
    ...
    .action((command) => {
        ...
        const artifact = deploymentService.artifactProcessor
            .checkPath(command)
        ...
        authenticate
            ...
            .then((con) => {
                ...
                return deploymentService.deploymentProcessor.mdapiDeploy(
                    command,
                    constants,
                    artifact,
                    con.token,
    ...
    .action((command) => {
        ...
        authenticate
            ...
            .then((con) => {
                ...
                deploymentService.deploymentProcessor.quickDeploy(
                    command,
                    constants,
                    artifact,
                    con.token,
