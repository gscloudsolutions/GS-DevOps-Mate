...
program
    ...
    .action((command) => {
        ...
        if (!command.targetusername) {
            ...
            authenticate
                .loginWithCreds(command.username, command.password, command.envType)
                .then((connection) => {
                    ...
                    return apexTestingService.getTestSubmission(
                        apexTestingService.testLevel[command.testLevel],
                ...
                .then((result) => {
                    ...
                    return apexTestingService.renameFiles(
                        command.directoryPath,
                ...
                .finally((result) => {
                    ...
                    if (testsRunResults.status === 0) {
                        if (command.slackWebhookUri) {
                            return notificationService.sendSuccessMessage(
                        ...
                        if (command.slackWebhookUri) {
                            return notificationService.sendFailureMessage(
                                command.slackWebhookUri,
                                testsRunResults.result.summary,
                                command.notificationTitle
                            );
