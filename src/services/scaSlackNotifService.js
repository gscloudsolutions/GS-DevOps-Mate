...
const generateSuccessMessage = async (summary, notifTitle) => {
    return await notify.generateFinalMessage(summary, notifTitle, prepareFinalMessage, "in-code-review", "ok");
};

const generateFailureMessage = async (summary, notifTitle) => {
    return await notify.generateFinalMessage(summary, notifTitle, prepareFinalMessage, "in-code-review", "fail");
};
