 ...
 */
function createMultipleArtifacts(srcProjectPath, locationToStoreArtifacts, packageVersion) {
 ...
 * @param {*} packageVersion
 */
function createCombinedArtifact(srcProjectPath, locationToStoreArtifacts, packageVersion) {
    // Will run if undefined i.e third argument is not passed
    return new Promise((resolve, reject) => {
        try {
...
const createMDAPIPackageArtifact = (projectLocation, artifactsLocation, packageVersion, doGitDiff) =>
