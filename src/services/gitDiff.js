 ...
 * @param {*} sfdxrepo
 */
const prepareDiffItemsList = (repoPath, nextCommit, previousCommit, sfdxrepo) =>
...
const createProjectJSON = (repoPath, diffProjectPath) =>
    new Promise((resolve, reject) => {
        try {
            // Reading the sfdx-project.json as the dependencies file
            const packageObj = fsExtra.readJSONSync(`${repoPath}/sfdx-project.json`);
...
const copyDiffContent = (repoPath, diffProjectPath) =>
    new Promise((resolve, reject) => {
        try {
