 ...
 */
const loginWithCreds = (username, password, environmentType) =>
...
const loginWithJWT = (clientId, severyKeyPath, sfUsername, orgAlias, envType, decryptionKey, decryptionIV) =>
    new Promise((resolve, reject) => {
        try {
            let command = "";
