...
const retrievePackage = (packageName, projectPath, accessSecret) =>
    new Promise((resolve, reject) => {
...
const mergePackageChanges = (source, destination, filesToIgnore) =>
    new Promise((resolve, reject) => {
        logger.debug("source: ", source);
        logger.debug("destination: ", destination);
        logger.debug("filesToIgnore: ", filesToIgnore);
...
const retrieveCompleteOrg = (conn, rootdir, cmpsFolderPath, srcFormat, deleteBackupDir, backUpOnBranch) =>
    new Promise((resolve, reject) => {
        try {
