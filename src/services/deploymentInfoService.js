...
const getDeploymentInfo = (moduleName, conn, buildId) =>
...
const updateDeploymentInfo = (moduleName, commitSHA, tag, connection, alias, deploymentRes) =>
    new Promise((resolve, reject) => {
...
const updateDeploymentInfoByName = (moduleName, commitSHA, targetUserName) =>
    new Promise((resolve, reject) => {
        shellJS.exec(
